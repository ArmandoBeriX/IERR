...
const FieldForm = ({ tableId, field, tablesData, onSave, onCancel, onDelete }) => {
  ...
  // NUEVO MEJORADO: Operadores disponibles por tipo de campo
  ...
  useEffect(() => {
    ...
    if (isEditing && field) {
      ...
      // NUEVO: Inicializar possibleValues si no existe
  ...
  // NUEVO: Manejar possibleValues para list
  ...
  // Funciones para filtros de relación (mantienen la misma lógica pero con operadores dinámicos)
  ...
  return (
    <form onSubmit={handleSubmit} className="field-form">
      ...
      {/* NUEVO: Valores Posibles para list */}
      ...
      {/* NUEVO: Formatos Válidos para attachment */}
      ...
      {/* Resto del formulario (propiedades generales) */}
      <div className="conditional-section">
