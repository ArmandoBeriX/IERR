...
const FieldForm = ({ tableId, field, tablesData, onSave, onCancel, onDelete }) => {
  ...
  useEffect(() => {
    ...
    if (isEditing && field) {
      ...
      // CORRECCIÓN: Cargar valores de checkbox de propiedades generales
      console.log('🔍 Propiedades generales del campo:');
      console.log('isRequired:', field.isRequired);
      console.log('isFilter:', field.isFilter);
      console.log('isUnique:', field.isUnique);
      console.log('isEditable:', field.isEditable);
      console.log('isVisible:', field.isVisible);
      console.log('history:', field.history);
      ...
      // CORRECCIÓN COMPLETA: Cargar TODOS los datos incluyendo propiedades generales
      const loadedData = {
        identifier: field.identifier || '',
        name: field.name || '',
        fieldFormat: fieldFormatValue,
        multiple: Boolean(field.multiple),
        // CORRECCIÓN: Cargar correctamente los checkbox de propiedades generales
        isRequired: field.isRequired !== undefined ? Boolean(field.isRequired) : false,
        isFilter: field.isFilter !== undefined ? Boolean(field.isFilter) : false,
        isUnique: field.isUnique !== undefined ? Boolean(field.isUnique) : false,
        ...
        // CORRECCIÓN: Cargar correctamente los checkbox de visibilidad y edición
      ...
      console.log('✅ Propiedades generales cargadas:', {
        isRequired: loadedData.isRequired,
        isFilter: loadedData.isFilter,
        isUnique: loadedData.isUnique,
        isEditable: loadedData.isEditable,
        isVisible: loadedData.isVisible,
  ...
  useEffect(() => {
    if (isEditing && field) {
      ...
      console.log('Propiedades generales recibidas:', {
      ...
      // CORRECCIÓN: Si no hay storeData o propiedades generales, buscar el campo completo en tablesData
      if (!field.storeData || Object.keys(field.storeData).length === 0 || 
          field.isRequired === undefined || field.isFilter === undefined) {
        console.log('⚠️ Campo incompleto, buscando en tablesData...');
        ...
        if (table) {
          ...
          if (fullField) {
            ...
            const loadedData = {
              ...
              // CORRECCIÓN: Cargar propiedades generales del campo completo
              isRequired: fullField.isRequired !== undefined ? Boolean(fullField.isRequired) : false,
              isFilter: fullField.isFilter !== undefined ? Boolean(fullField.isFilter) : false,
              isUnique: fullField.isUnique !== undefined ? Boolean(fullField.isUnique) : false,
              ...
              // CORRECCIÓN: Cargar visibilidad y edición del campo completo
            ...
            console.log('✅ Propiedades generales recargadas:', {
              isRequired: loadedData.isRequired,
              isFilter: loadedData.isFilter,
              isUnique: loadedData.isUnique,
              isEditable: loadedData.isEditable,
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Propiedades generales a guardar:', {
    ...
    const submitData = {
      ...
      // CORRECCIÓN: Guardar propiedades generales correctamente
      ...
      // CORRECCIÓN: Guardar visibilidad y edición correctamente
    ...
    console.log('✅ Propiedades generales enviadas:', {
      isRequired: submitData.isRequired,
      isFilter: submitData.isFilter,
      isUnique: submitData.isUnique,
      isEditable: submitData.isEditable,
